...
DEFAULT_RESOURCES = ['public.mars-0.4.1.zip', 'public.pyodps-0.9.2.zip']
    ...
    def submit(self, worker_num=1, worker_cpu=8, worker_mem=32, disk_num=1, min_worker_num=None, cache_mem=None,
        ...
        try:
            ...
            if self._kube_instance is None:
                ...
                mars_config['scheduler_mem'] = kw.pop('scheduler_mem', 8)
                mars_config['scheduler_cpu'] = kw.pop('scheduler_cpu', 32)
